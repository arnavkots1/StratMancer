...
>(({ className, variant = 'default', ...props }, ref) => {
  const variantClasses = {
    ...
    premium: "bg-gradient-to-br from-black/30 via-black/20 to-black/30 backdrop-blur-lg",
  }
...
>(({ className, children, variant = 'default', ...props }, ref) => {
  const variantClasses = {
    ...
    premium: "bg-gradient-to-br from-background/80 to-background/60 backdrop-blur-lg border border-white/20 shadow-elite",
  }
